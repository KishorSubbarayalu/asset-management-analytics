...
CREATE VIEW SECURITY_REGION_PERF AS (
WITH client_holding AS (
SELECT 
	*,ROUND(AMOUNT*RATE,2) AS AMOUNT_EUR
FROM sample_asset_management.holdings H
...
CREATE VIEW CLIENT_ASST_DIST AS (
WITH client_holding AS (
SELECT 
	*,ROUND(AMOUNT*RATE,2) AS AMOUNT_EUR
FROM sample_asset_management.holdings H
